...
container.classList.value = "container" // add className for div element
// New element created now have to add it to the DOM
...
// iterates and create items
  // wrap all the items on the container created
  // <div> img + brand + description + price + rating </div>
...
for (let i = 0; i < data.length; i++) {
    ...
    // append the card the the container
    ...
    brand.textContent = `Brand: ${data[i].brand}`
